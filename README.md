...
![docs/Screen_Shot_2020-06-08_at_11.49.09_(2).png](docs/Screen_Shot_2020-06-08_at_11.49.09_(2).png)
...
![docs/Screen_Shot_2020-06-08_at_2.19.15.png](docs/Screen_Shot_2020-06-08_at_2.19.15.png)

Learn more를 누르면 시리즈 소개 화면이 있는데, 왜 스크린샷은 없을까요? 저 Learn more는 버튼 모양의 링크가 아니라 정말로 버튼이었습니다;

![docs/Screen_Shot_2020-06-08_at_2.20.40.png](docs/Screen_Shot_2020-06-08_at_2.20.40.png)

엉망으로 만들어도 Google님이 알아서 해주실거야! 생각했지만, "안 돼, 안 찾아줘, 찾아줄 생각 없어, 돌아가."인 ORC 검색 결과
